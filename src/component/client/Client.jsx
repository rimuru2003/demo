  ...
  return (
    <div className="relative w-full h-screen bg-[#F9F6EE] overflow-hidden flex items-center justify-end">
        ...
        >
          {logos.map((logo, index) => (
            <img
              ...
              src={logo}
              alt={`logo-${index}`}
              className="xl:h-24 h-10 xl:mx-10 mx-8 "
            />
          ))}
        </Marquee>
      </div>
        ...
        >
          {logos.map((logo, index) => (
            <img
              ...
              src={logo}
              alt={`logo-${index}`}
              className="xl:h-24 h-10 xl:mx-10 mx-8 invert brightness-0"
            />
          ))}
        </Marquee>
      </div>
      ...
      <div className="relative pr-8 z-10 text-end">
        <h1 className="xl:text-[6rem] text-[3rem]  font-extrabold text-[#1A1A1A] leading-[80px]">
          These brands <br />
          we worked with.
        </h1>
      </div>
